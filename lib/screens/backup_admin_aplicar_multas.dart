...
class _AdminAplicarMultasScreenSimpleState extends State<AdminAplicarMultasScreenSimple> {
  ...
  void _showAplicarMultaDialog() async {
    ...
    try {
      ...
      print('DEBUG: Iniciando carga de tipos de multa...');
      tiposMulta = await AdminDetalleMultaService.getTiposMulta();
      print('DEBUG: Tipos de multa cargados: ${tiposMulta.length}');
      
      print('DEBUG: Iniciando carga de propiedades...');
      propiedades = await AdminDetalleMultaService.getPropiedades();
      print('DEBUG: Propiedades cargadas: ${propiedades.length}');
      
      Navigator.pop(context); // Cerrar diálogo de carga
      
      print('DEBUG: Validando datos cargados...');
      if (tiposMulta.isEmpty || propiedades.isEmpty) {
        print('DEBUG: Error - Datos insuficientes. Multas: ${tiposMulta.length}, Propiedades: ${propiedades.length}');
      ...
      print('DEBUG: Datos validados correctamente, mostrando formulario...');
      ...
      Navigator.pop(context);
      print('DEBUG: Error en _mostrarDialogoAplicarMulta: $e');
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
